...
const ImplementationServices = () => {
  ...
  return (
    <section className="w-full md:my-16">
      ...
      {/* Hero Image */}
      <div className="w-full h-[70dvh] bg-fixed bg-no-repeat bg-cover bg-[url('/assets/ImpleServices.svg')] flex flex-col justify-center items-center" style={{ clipPath: "polygon(0% 0%, 100% 0px, 100% 80%, 51% 100%, 0px 80%, 0px 0px)" }}>

        <h1 className='md:text-5xl text-2xl text-white'>Implementation service </h1>
        <p className='md:text-2xl text-xl text-white my-6 px-5 '>"Seamless deployment of tailored solutions to optimize business operations efficiently."</p>
      </div>
