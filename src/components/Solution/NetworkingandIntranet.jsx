...
const NetworkingandIntranet = () => {
  ...
  return (
    <section className="w-full md:my-16">
      {/* Hero Image */}
      <div
        className="w-full h-[70dvh] bg-fixed bg-no-repeat bg-cover bg-[url('/assets/Networkinbanner.svg')] flex flex-col justify-center items-center"
        style={{
          clipPath:
      ...
      >
        ...
        <p className="md:text-2xl text-xl text-white my-6 pl-5 ">
          Enabling communication between devices and users.
        </p>
      </div>
