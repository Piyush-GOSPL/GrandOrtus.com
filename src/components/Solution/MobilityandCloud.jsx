...
const MobilityandCloud = () => {
  ...
  return (
    ...
    {/* Hero Image */}
    <div
      className="w-full h-[70dvh] bg-no-repeat bg-cover bg-[url('/assets/MobilityBanner.svg')] flex flex-col justify-center items-center"
      style={{
        clipPath:
    ...
    >
      ...
      "Seamless deployment of tailored solutions to optimize business operations efficiently."      </p>
    </div>
