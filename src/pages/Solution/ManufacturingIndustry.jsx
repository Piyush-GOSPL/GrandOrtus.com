...
const ManufacturingIndustry = () => {
  return (
    <section className="w-full">
      {/* Header Section */}
     <SolutionSection heading={'Manufacturing Industry'} subheading={'Streamline operations and enhance efficiency with modern IT solutions.'} backgroundImage={'/assets/ManufacturingInd.png'} />
