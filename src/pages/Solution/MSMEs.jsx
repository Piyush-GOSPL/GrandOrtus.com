...
const MSMEs = () => {
  ...
  return (
    <section className="w-full">
      ...
      <BannerSection  heading="Importance of MSMEs in the economy" subheading="Role of systems integrators in modernizing and optimizing MSMEs." bgImage="/assets/MSME.svg" />
