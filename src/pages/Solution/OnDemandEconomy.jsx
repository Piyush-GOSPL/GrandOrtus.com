...
const OnDemandEconomy = () => {
  ...
  return (
    <section className="w-full">
      ...
      <SolutionSection  heading={'Empowering the On-Demand Economy'} subheading={' The on-demand economy thrives on speed, convenience, and instant access, with technology serving as its backbone.'} backgroundImage={'/assets/On-DemandEconomy.png'}/>
