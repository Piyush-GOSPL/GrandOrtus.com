  ...
  return (
    <section className="w-full">
      ...
      <SolutionSection
        ...
        subheading={
          "Innovate and scale with smart IT solutions to transform the healthcare industry."
        }
        backgroundImage={"/assets/HealthcareIndustry.png"}
      />

      {/* Technology Benefits Section */}
      <div className="w-full py-12  md:my-20 ">
