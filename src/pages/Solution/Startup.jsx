  ...
  return (
    <section className="w-full ">
      ...
      {/* <SolutionSection heading="Building Startup Infrastructure: Role of the System Integrator"  subheading=" A deep dive into the critical role of system integrators in startup
          infrastructure" backgroundImage="/assets/START_UP1.png"/> */}

          <BannerSection heading="Building Startup Infrastructure: Role of the System Integrator" subheading="A deep dive into the critical role of system integrators in startup
          infrastructure" bgImage="/assets/START-UP.png"/>
