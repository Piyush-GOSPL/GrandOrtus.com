...
const RetailIndustry = () => {
  ...
  return (
    <section className="w-full font-sans text-gray-800">
      {/* Hero Section */}
      <SolutionSection  heading={'Revolutionizing Retail Experiences'} subheading={'Empowering businesses with cutting-edge technology to deliver unparalleled customer satisfaction'} backgroundImage={'/assets/RetailExperiences.png'}/>
