...
const RealMoneyGaming = () => {
  ...
  return (
    <section className="w-full">
      {/* Hero Section */}
      <SolutionSection heading={'Real Money Gaming Industry'} subheading={'Streamline operations and enhance efficiency with modern IT solutions'} backgroundImage={'/assets/RealMoneyGamingIndustry.png'}/>
