...
const services = [
  ...
  {
    title: "Networking and Intranet",
    icon: "./assets/icon.svg",
    path: '/CyberSecurity',       
    points: [
      "Connects multiple devices globally",
      "Enables data sharing seamlessly.",
      "Restricted access for internal users.",
    ],
  },
  {
  ...
  {
    title: "Mobility and Cloud",
    icon: "./assets/icon.svg",
    path: '/MobilityandCloud',
    points: [
      "Site Selection Process Evaluation.",
      "Network Topology and Design",
      "Cooling and Power Setup",
    ],
  },
  {
    title: "Datacenter infra Design & Deployment",
    icon: "./assets/icon.svg",
    path: '/Datacenter',
    points: [
      "Site Selection Process Evaluation.",
  ...
  },
  {
    ...
    points: [
      ...
      "Ensures network vulnerability mitigation.",
  ...
  return (
    ...
    <section className="w-full mx-auto relative">
      <div className="service-section py-10 text-center">
        <h3 className="text-[30px] font-bold max-w-3xl mx-auto">Our Services</h3>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 p-10 gap-10  bg-after-[#575757] after:content-[''] after:absolute after:w-full after:h-[200px]  after:bottom-[20px] after:left-0 after:-z-10">
        ...
        <Link to={service.path}>
          ...
          >
            ...
            <div className="bg-[#0090d2] p-5 min-h-[130px]">
              <h1 className="mt-8 text-[20px] text-center text-white">
                {service.title}
              </h1>
            </div>

            <ul className="list-disc p-[30px] mt-2 space-y-3">
