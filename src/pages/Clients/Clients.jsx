...
const Clients = () => {
  ...
  return (
    <section className="">
      <BannerSection heading="Clients" subheading="We’re grateful for your trust and thrilled to contribute to your
            success - your happiness is our top priority!" bgImage="/assets/client1.png" />
